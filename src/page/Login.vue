  ...
  <div class="page-login">
    ...
    <div class="login-panel">
      ...
      <div class="form">
        ...
        <el-button type="primary" class="btn-login" @click="commit">登录</el-button>
        <p class="reg">
          <span>还没有账号？</span>
        ...
        <div class="oauth-wrapper J-oauth-wrapper">
          ...
          <div class="oauth cf">
            <span class="oauth__link oauth__link--qq third-login-btn" id="J-third-tencent"></span>
            <span class="oauth__link oauth__link--weibo third-login-btn" id="J-third-sina"></span>
          </div>
